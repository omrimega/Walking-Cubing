...
public class SplashScreen implements Screen {
    ...
    private final TryPhysicsGame app;
    private Stage stage;

    private Image splashImg;

    public SplashScreen(final TryPhysicsGame app) {
        this.app = app;
    ...
    public void show() {
        ...
        Texture splashTex = new Texture ("intro.png");
        ...
        splashImg.addAction(sequence(alpha(0), scaleTo(.1f, .1f),
                parallel(fadeIn(3f, Interpolation.bounce),
                        scaleTo(2f, 2f, 2.5f, Interpolation.pow5),
                        moveTo(stage.getWidth() / 2 - 32, stage.getHeight() / 2 - 32, 2f, Interpolation.linear)),
